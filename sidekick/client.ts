...
import WhatsAppBot from "./sidekick";
...
class Client {
    ...
    async getGroupMetaData(jid: string, WhatsAppBot: WhatsAppBot) {
        ...
        WhatsAppBot.groupName = WhatsAppBot.isGroup ? groupMetadata.subject : null;
        WhatsAppBot.groupMembers = WhatsAppBot.isGroup ? groupMetadata.participants : null;
        WhatsAppBot.groupAdmins = WhatsAppBot.isGroup ? getGroupAdmins(WhatsAppBot.groupMembers) : null;
        WhatsAppBot.groupId = WhatsAppBot.isGroup ? groupMetadata.id : null;
        WhatsAppBot.isBotGroupAdmin = WhatsAppBot.isGroup ? (WhatsAppBot.groupAdmins.includes(WhatsAppBot.owner)) : false;
        WhatsAppBot.isSenderGroupAdmin = WhatsAppBot.isGroup ? (WhatsAppBot.groupAdmins.includes(WhatsAppBot.sender)) : false;
    }
}
