...
//     demo: { isEnabled: true, text: ['.cpp printf("Hello from WhatsAppBot!");', '.cpp float x, y;\ncin >> x >> y;\ncout<<"sum of provide numbers is -> " << x + y; -i 6 0.9', '.cpp #include <bits/stdc++.h>\nusing namespace std;\n\nint main() {\n  cout << "WhatsAppBot is the best!" << endl;\n}'] },
//     async handle(client: Client, chat: proto.IWebMessageInfo, WhatsAppBot: WhatsAppBot
...
//                 cpp = code;
//             }
//             let filename = './tmp/cpp-WhatsAppBot
// ' + chat.key.id +'.cpp';
//             let outname = './tmp/cpp-WhatsAppBot
// ' + chat.key.id +'.out';
...
//                             MessageType.text
//                         )
//                         await client.deleteMessage(WhatsAppBot
// .chatId, {
//                             id: processing.key.id,
//                             remoteJid: WhatsAppBot
// .chatId,
//                             fromMe: true,
//                         })
//                     }
...
//                     MessageType.text
//                 )
//                 return await client.deleteMessage(WhatsAppBot
// .chatId, {
//                     id: processing.key.id,
//                     remoteJid: WhatsAppBot
// .chatId,
